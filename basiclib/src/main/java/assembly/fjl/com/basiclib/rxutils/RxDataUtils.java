...
import static assembly.fjl.com.basiclib.rxutils.RxConstUtils.*;
...
public class RxDataUtils {
     ...
     * @param byteNum 字节数
     * @param unit    <ul>
     *                <li>{@link RxConstUtils.MemoryUnit#BYTE}: 字节</li>
     *                <li>{@link RxConstUtils.MemoryUnit#KB}  : 千字节</li>
     *                <li>{@link RxConstUtils.MemoryUnit#MB}  : 兆</li>
     *                <li>{@link RxConstUtils.MemoryUnit#GB}  : GB</li>
     *                </ul>
     * @return 以unit为单位的size
     */
    public static double byte2Size(long byteNum, RxConstUtils.MemoryUnit unit) {
     ...
     * @return 字节数
     */
    public static long size2Byte(long size, RxConstUtils.MemoryUnit unit) {
        if (size < 0) return -1;
        switch (unit) {
            default:
            case BYTE:
